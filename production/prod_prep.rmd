...
data01 <- read_spss(path = "input/data/original/factorial_ola1.sav")
...
long02<- 
  left_join(long01,data01[,c("ResponseId","Finished","sexo","edad",
...
vig_resp<- 
  ...
  select(respondeid,deck,id,deck_vig,everything(),-p1)  
```
